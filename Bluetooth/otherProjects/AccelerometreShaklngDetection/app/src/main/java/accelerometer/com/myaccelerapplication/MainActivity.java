package accelerometer.com.myaccelerapplication;
...
public class MainActivity extends Activity implements SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        m_coloredView = findViewById(R.id.coloredView);
        m_coloredView.setBackgroundColor(Color.GREEN);

        m_XTextView = (TextView)findViewById(R.id.XTextView);
        m_YTextView = (TextView)findViewById(R.id.YTextView);
        m_ZTextView = (TextView)findViewById(R.id.ZTextView);
    ...
    private void getAccelerometer(SensorEvent event) {
        ...
        if (accelationSquareRoot >= 2) //
        {
            ...
            if (color) {
                ...
                m_coloredView.setBackgroundColor(Color.RED);
            }
            color = !color;
        }
    }
